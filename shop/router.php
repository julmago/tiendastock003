...
error_log("storefront router shop: host=".($_SERVER['HTTP_HOST'] ?? '')." path=".$path." raw_slug=".$rawSlug." slug=".$slug);
...
if (!$products) echo "<p>Sin productos.</p>";
  ...
  foreach($products as $p){
    ...
    // Cambio clave: stock minorista se toma del propio catálogo (sin proveedor directo).
