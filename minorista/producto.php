...
<form id='provider-link-form' method='post' style='max-width:820px;'>
  ...
  <div style='display:flex; gap:8px; align-items:center;'>
    <input type='text' id='provider-product-search' placeholder='Buscar producto del mayorista…' style='flex:1; padding:6px;'>
...
if (!$linkedProducts) {
  ...
  <thead><tr><th>Mayorista</th><th>Título</th><th>SKU</th><th>Código universal</th><th>Stock</th><th>Precio</th><th>Acciones</th></tr></thead><tbody>";
...
(function() {
  ...
  function ensureResultsTable() {
    ...
    if (!table) {
      ...
      table.innerHTML = "<thead><tr><th>Mayorista</th><th>Título</th><th>SKU</th><th>Código universal</th><th>Stock</th><th>Precio</th><th>Acciones</th></tr></thead><tbody></tbody>";
  ...
  function fetchResults(query) {
    ...
    fetch('/minorista/api/provider_products_search.php?' + params.toString(), {
  ...
  function linkProviderProduct(linkedId, rowEl) {
    ...
    fetch('/minorista/api/link_product.php', {
      method: 'POST',
      headers: {
